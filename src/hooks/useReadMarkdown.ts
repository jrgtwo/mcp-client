...
export function useReadMarkdown() {
  ...
  async function readMarkdown() {
    ...
    try {
      const results = await client.callTool('read_markdown', { file_path: path, max_chars: maxChars }, nextId())
  ...
  return { filePath, setFilePath, maxChars, setMaxChars, result, loading, error, readMarkdown, handleKeyDown }
}
