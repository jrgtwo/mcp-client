...
export default function AgentChat() {
  const { messages, input, setInput, maxSteps, setMaxSteps, loading, send, handleKeyDown, bottomRef } = useAgentChat()
    ...
    <div className="flex flex-col h-[calc(100vh-105px)]">
      ...
      <div className="flex flex-col gap-2 p-3 border-t">
        ...
        <div className="flex items-center gap-2 text-sm text-muted-foreground">
          <label htmlFor="agent-chat-max-steps">Max steps</label>
          <Input
            id="agent-chat-max-steps"
            type="number"
            min={1}
            max={20}
            value={maxSteps}
